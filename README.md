...
```html
<link rel="stylesheet" href="assets/lesson.css?v=17">
...
...
<script src="assets/lesson.js?v=17" defer></script>
<script src="assets/pwa.js?v=17" defer></script>
```
...
y subir `const VERSION = '17'` a `'18'` en `sw.js` (eso cambia el nombre del cache
y descarta el viejo).
